...
base_cmd = "python3 -m torch.distributed.launch --nproc_per_node={} --master_port=9999 tools/train_net_fix_backbone.py".format(NGPUS) +\
...
for name, num in zip(all_names, img_numbers):
    ...
    output_dir = "./results/ft_base/{}/fix_backbone/{}".format(part_name, name)
