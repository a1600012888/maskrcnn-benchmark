...
_C.MODEL.BACKBONE.SCC_DIVERSE_REG = False

_C.MODEL.SCC = CN()
_C.MODEL.SCC.REG_LOSS = CN()

_C.MODEL.SCC.REG_LOSS.ALPHA = 0.6
_C.MODEL.SCC.REG_LOSS.BETA = 0.4
_C.MODEL.SCC.REG_LOSS.LAMBDA = 0.2
